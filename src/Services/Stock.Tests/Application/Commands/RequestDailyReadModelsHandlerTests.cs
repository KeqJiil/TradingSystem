...
public class RequestDailyReadModelsHandlerTests
{
    ...
    private RequestDailyReadModelsHandler CreateHandler()
    {
        return new RequestDailyReadModelsHandler(_outboxWriter.Object, _stockDataReader.Object);
    }
    ...
    public async Task NoStocks_DoesNotWriteAnything()
    {
        ...
        await CreateHandler().Handle(new RequestDailyReadModelsCommand(DateTime.UtcNow), CancellationToken.None);
    ...
    public async Task PayloadMapping_UsesStockIdAndDateFromRequest()
    {
        ...
        await CreateHandler().Handle(new RequestDailyReadModelsCommand(requestDate), CancellationToken.None);
